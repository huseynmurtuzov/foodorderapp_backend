...
namespace YemekSepeti.Migrations
{
    ...
    [Migration("20241227225232_Addview")]
            ...
            modelBuilder.Entity("YemekSepeti.DTO.DeliveryPersonnelPerformance", b =>
                {
                    ...
                    b.ToView("vw_DeliveryPersonnelPerformance", (string)null);
                });
            ...
            modelBuilder.Entity("YemekSepeti.Models.Order", b =>
                {
                    ...
                    b.ToTable("Orders", t =>
                        {
                            t.HasTrigger("trg_SetOrderStatus");
                        });
            ...
            modelBuilder.Entity("YemekSepeti.Models.RestaurantReview", b =>
                {
                    ...
                    b.ToTable("RestaurantReviews", t =>
                        {
                            t.HasTrigger("trg_UpdateRestaurantRating");

                            t.HasTrigger("trg_UpdateRestaurantRatingAfterDeletingReview");
                        });
